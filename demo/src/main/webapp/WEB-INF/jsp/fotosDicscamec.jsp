...
<body>
	...
	<div id="gallery">
		<ul>
			<% List<SiminImagen> lista = (List<SiminImagen>)request.getAttribute("limagenes");
				for(SiminImagen img : lista){
			%>
			<li>
				<a href="img.htm?id=<%=img.getCoImgCodigo()%>" title="texto 1">
					<img alt="<%=img.getNaImgNombre() %>" src="img.htm?id=<%=img.getCoImgCodigo()%>" width="120" height="100" alt=""/>
				</a>		
			</li>
			<%
				}
