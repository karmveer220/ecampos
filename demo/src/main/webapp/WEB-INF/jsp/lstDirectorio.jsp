		      	...
		      	<tr>
		        	<td height="150" valign="top" bgcolor="#FFFFFF">	
		        		...
		        		<table width="700" border="0" class="">
		        			...
		        			<tr>
		        				<th colspan="7" class="tituloEncabezado">Directorio </th>
		        			</tr>
		        			<tr><td colspan="7">&nbsp;</td></tr>
		        			<tr>
		        				<td>Dependencia </td>
		       					<td>:</td>
		       					<td>
		       						<input type="text" name="Dep" id="fechaInicio" maxlength="10" class="texto"
						size="10" />
		       					...
		       					<td>:</td>
								<td>
									<input type="text" name="Ofi" id="fechaFin"  maxlength="10" class="texto" size="10" />
									
								</td>
								<td>                	
		                   			<div align="left">                      
	                     				<a href="javascript:buscarDirectorio();"><img width="30" height="30" src="images/buscar.png" border="0" alt="Buscar"/></a>                
		                   			</div>
                    			</td>
							</tr>
		        			<tr>
