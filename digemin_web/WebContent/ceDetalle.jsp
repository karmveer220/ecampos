...
<%@page import="gob.min.digemin.ejb.entitiesWeb.Simpais1"%>
<%@page import="gob.min.digemin.ejb.entitiesWeb.Simcarnetextranjeria1"%>
<%
  ...
  <head>
	...
	<SCRIPT language="JavaScript" type="text/javascript">
             function imprimir(){ 
                ...
                window.open("print_ce.jsp","carga",features);
            }
