 ...
 */
@Embeddable
public class T025pernatPK implements Serializable {
    ...
    public T025pernatPK(short annTramite, int numTramite, String codTipdoc, String numDocum) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof T025pernatPK)) {
            return false;
        }
        T025pernatPK other = (T025pernatPK) object;
    ...
    public String toString() {
        return "pe.gob.pcm.constitucion.web.model.T025pernatPK[annTramite=" + annTramite + ", numTramite=" + numTramite + ", codTipdoc=" + codTipdoc + ", numDocum=" + numDocum + "]";
    }
