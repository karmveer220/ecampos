...
function comboOficinaRegistral(obj){
	if(obj.options[obj.selectedIndex].value != ""){
		ajax.requestFile = "comboficinaregistral.htm";
		ajax.method = "POST";
		ajax.setVar("cod", obj.options[obj.selectedIndex].value);
		ajax.onCompletion = comboOficinaRegistralCom;
		ajax.runAJAX();
	}
}
...
function comboOficinaRegistralCom(){
	...
	tmp = tmp.split(";");
	lista.options[0] = new Option("Oficina Registral", "");	
...
function comboDepartamento(obj){
	if(obj.options[obj.selectedIndex].value != ""){
		ajax.requestFile = "comboProvincias.htm";
		ajax.method = "POST";
		ajax.setVar("cod", obj.options[obj.selectedIndex].value);
		ajax.onCompletion = comboDepartamentoCom;
		ajax.runAJAX();
	}
}
