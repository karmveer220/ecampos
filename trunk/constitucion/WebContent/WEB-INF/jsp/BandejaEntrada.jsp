				...
				<div align="center" style="color: blue"> <%=mensaje %> </div>
				 ...
				 <display:table  name="requestScope.lBandeja" requestURI="bandeja.htm"  class="displaytag" pagesize="10"
		            ...
		            <display:column title="Acciones">
		            	...
		            	<a href="recibirTramite.htm?codigo=${row.numTramite}" onclick="return confirm('Seguro de recibir el tramite?')"><img title="Recibir" src="${pageContext.request.contextPath}/img/application_put.png" height="16px" width="16px"/></a>
		            	<a href="eliminarTramite.htm?codigo=${row.numTramite}"><img title="Eliminar" src="${pageContext.request.contextPath}/img/delete.png" height="16px" width="16px"/></a>
					</display:column>
		   		</display:table>
