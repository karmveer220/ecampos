    ...
    <table width="100%">
        <tr>
            <td height="233">
				...
				<display:table  name="requestScope.lEnviados" requestURI="enviados.htm"  class="displaytag" pagesize="10"
		            ...
		            <display:column title="Presentacion" property="codPresenta" sortable="true" headerClass="sortable" />
		            ...
		            <display:column title="Fec Envio" sortable="true" headerClass="sortable">
		            	<fmt:formatDate value="${row.fecEnvio}" pattern="dd/MM/yyyy"/>
		            </display:column>
