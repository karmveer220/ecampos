...
CREATE TABLE t020tramite (
  ...
  IND_LIBROSOC CHAR(1) NOT NULL,
  IND_LIBROCON CHAR(1) NOT NULL,
  NUM_CUO CHAR(20) NOT NULL,
  IND_CUO CHAR(1) NOT NULL,
  ...
  IND_CANCECAPI CHAR(1) NOT NULL,
  NUM_PORCENCANC INTEGER(11) NOT NULL,
  MTO_DEREREGIS DECIMAL(15,2) NOT NULL,
  IND_FORMAPAGO CHAR(1) NOT NULL,
  IND_PSC CHAR(1) NOT NULL,
