...
<html:form action="/pasaporte.do">
	<input type="hidden" name="method" value="buscarPasaporte" />
	...
	<table width="600px" cellpadding="4" cellspacing="0" class="tFormulario">
		<tr>
			...
			<td width="83"><input name="btnBuscar" type="submit" class="botonAz" value="Buscar">
				<br />
				<br />
	...
	<div style="width: 600px"><display:table requestURI="listaPas.do"
		name="sessionScope.listaPersonas" class="displaytag" pagesize="10"
		defaultsort="1" defaultorder="ascending" export="false" id="row"
		excludedParams="ajax">
