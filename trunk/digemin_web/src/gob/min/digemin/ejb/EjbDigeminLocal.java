...
public interface EjbDigeminLocal {
	
	/* *****PERSONA******/    
    public List<Simpersona1> listaPersonaPorNombres(BeanRequest request);
    public List<Simpersona1> listaPersonaPorNombresCondoc(BeanRequest request);
    ...
    /* SEGURIDAD */
    public String autenticaSession(String usuario, String clave)throws java.lang.Exception;
}
