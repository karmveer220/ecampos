...
/**
 * Bean para enviar informacion de auditoria del sistema</br>
...
public class BeanAuditoria implements Serializable{
    ...
    public BeanAuditoria(Long usuarioRegistro) {
        this.usuarioRegistro=usuarioRegistro;
    }
    public BeanAuditoria(Long usuarioRegistro,String username) {
        this.usuarioRegistro=usuarioRegistro;
