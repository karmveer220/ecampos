...
<html>
<head >
<title>Manual de Procedimientos del Ministerio del Interior</title>
					...
					<tr>
						<td height="150" valign="top"><br />
							<table width="700" border="0" class="">
								...
								<tr>
									<td>
										<iframe scrolling="yes" frameborder="0" width="700" height="600" src="http://www.mininter.gob.pe/contenido_02_deta.php?codmenu=2&niv1=8&niv2=3&niv3=24"></iframe>
									</td>
								</tr>
							</table>
						</td>
